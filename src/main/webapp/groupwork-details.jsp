...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <c:forEach var="item2" items="${usernamelist}">
                <div class="row">
                    <div class="col-xs-12">
                        <a href="#" class="group-title">
                            <img width="30" src="<c:url value="/plugins/images/users/pawandeep.jpg"/> "
                                 class="img-circle"/>
                            <span>${item2}</span>
                        </a>
                    </div>
                    <c:forEach var="item" items="${joblist}">
                        <c:if test="${item.getUserName().equalsIgnoreCase(item2)}">
                            <div class="col-md-4">
                                <div class="white-box">
                                    <h3 class="box-title">${item.getStatusName()}</h3>
                                    <div class="message-center">
                                        <a href="#">
                                            <div class="mail-contnet">
                                                <h5>Tên công việc</h5> <span
                                                    class="mail-desc">${item.getName()}</span>
                                            </div>
                                        </a>
                                        <a href="#">
                                            <div class="mail-contnet">
                                                <h5>Ngày bắt đầu</h5> <span
                                                    class="mail-desc">${item.getStartDate()}</span>
                                            </div>
                                        </a>
                                        <a href="#">
                                            <div class="mail-contnet">
                                                <h5>Ngày kết thúc</h5> <span
                                                    class="mail-desc">${item.getEndDate()}</span>
                                            </div>
                                        </a>
