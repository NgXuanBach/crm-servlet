...
<head>
    ...
    <!-- Menu CSS -->
    <link href=
          <c:url value="/plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css"/> rel="stylesheet">
    <!-- animation CSS -->
    <link href=
          <c:url value="/css/animate.css"/> rel="stylesheet">
    <!-- Custom CSS -->
    <link href=
          <c:url value="/css/style.css"/> rel="stylesheet">
    <!-- color CSS -->
    <link href=
          <c:url value="/css/colors/blue-dark.css"/> id="theme" rel="stylesheet">
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse slimscrollsidebar">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="<c:url value="/project"/>" class="waves-effect"><i class="fa fa-table fa-fw"
                                                                                aria-hidden="true"></i><span
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <h3 class="m">${msg}</h3>
                        <form action="<c:url value="/profile/edit?jobId=${job.getId()}"/> " method="post"
                              class="form-horizontal form-material">
                            <div class="form-group">
                                <label class="col-md-12">Tên công việc</label>
                                <div class="col-md-12">
                                    <input type="text" readonly value="${job.getName()}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" readonly value="${job.getProjectName()}"
                                           class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" readonly value="${job.getStartDate()}"
                                           class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" readonly value="${job.getEndDate()}"
                                           class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <select name="profileStatus" class="form-control form-control-line">
                                        <c:if test="${job.getStatusName().equalsIgnoreCase('chưa thực hiện')}">
                                            <option value="1" selected>Chưa thực hiện</option>
                                            <option value="2">Đang thực hiện</option>
                                            <option value="3">Đã hoàn thành</option>
                                        </c:if>
                                        <c:if test="${job.getStatusName().equalsIgnoreCase('đang thực hiện')}">
                                            <option value="1">Chưa thực hiện</option>
                                            <option value="2" selected>Đang thực hiện</option>
                                            <option value="3">Đã hoàn thành</option>
                                        </c:if>
                                        <c:if test="${job.getStatusName().equalsIgnoreCase('đã hoàn thành')}">
                                            <option value="1">Chưa thực hiện</option>
                                            <option value="2">Đang thực hiện</option>
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <button type="submit"
                                            class="btn btn-success btn-update-jobstatus">Lưu lại
                                    </button>
...
<%--<script src="<c:url value="/js/profile-edit.js"/> "></script>--%>
</body>
