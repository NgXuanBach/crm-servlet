                    ...
                    <div class="white-box">
                        <div class="table-responsive">
                            <table class="table" id="example">
                                ...
                                <tbody>
                                <c:forEach var="i" begin="0" end="${listUsers.size()-1}">
                                    <tr>
                                        <td>${listUsers.get(i).getId()}</td>
                                        <td>${listUsers.get(i).getEmail()}</td>
                                        <td>${listUsers.get(i).getFullName()}</td>
                                        <td>${roleNameList.get(i)}</td>
                                        <td>
                                            <a href="<c:url value="/user/edit?userId=${listUsers.get(i).getId()}"/>"
                                               class="btn btn-sm btn-primary">Sửa</a>
                                            <a href="#" user-id="${listUsers.get(i).getId()}"
                                               class="btn btn-sm btn-danger btn-delete-user">Xóa</a>
                                            <a href="<c:url value="/user/detail?userId=${listUsers.get(i).getId()}"/> "
...
<script src="<c:url value="/js/user_table.js"/> "></script>
