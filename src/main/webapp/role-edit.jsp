        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-12">
                    <div class="white-box">
                        <h2>${msg}</h2>
                        <form action="<c:url value="/role/update?roleId=${roleId}"/> " method="post" class="form-horizontal form-material">
                            <div class="form-group">
                                <label class="col-md-12">Tên quyền</label>
                                <div class="col-md-12">
                                    <input type="text" value="${roleName}" placeholder="Tên quyền" name="name"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" value="${roleDesc}" placeholder="Mô tả" name="description"
                                           class="form-control form-control-line"/>
                                </div>
                            </div>
                            <div class="form-group">
